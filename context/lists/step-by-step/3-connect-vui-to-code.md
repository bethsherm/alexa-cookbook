...
On [page #1](https://github.com/AlexaStaging/alexa-cookbook/blob/master/context/lists/step-by-step/1-voice-user-interface.md) of this guide, we created a voice user interface for the intents and utterances we expect from our users.  On [page #2](https://github.com/AlexaStaging/alexa-cookbook/blob/master/context/lists/step-by-step/2-lambda-function.md), we created a Lambda function that contains all of our logic for the skill.  On this page, we need to connect those two pieces together.
...
7.  **Configure the Skill to Request Customer Permissions for the List Permissions** In the Permissions section, select Lists Read or Lists Write or both, depending on which your skill uses.

    <img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/ask-customskills/skillpermissions._V511356607_.png" /></a>

8.  **Click the "Next" button to continue to page #4 of this guide.**
...
<br/><br/>
<a href="https://github.com/AlexaStaging/alexa-cookbook/blob/master/context/lists/step-by-step/4-testing.md"><img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/buttons/button_next_testing._TTH_.png" /></a>
